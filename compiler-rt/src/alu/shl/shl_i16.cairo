...
pub fn __llvm_shl_z_z_z(ref state: RTState, n: u128, shift: u128) -> u128 {
    shl::<u16>(n, shift)
}
...
mod tests {
    ...
    fn test_i16() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_shl_z_z_z(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
