...
mod tests {
    ...
    pub const test_cases: [TestCase; 41] = [
        ...
        TestCase { lhs: 0b1111111111111111, rhs: 1, expected: 0b1111111111111110 },
        TestCase { lhs: 0b1111111111111111, rhs: 2, expected: 0b1111111111111100 },
        TestCase { lhs: 0b1111111111111111, rhs: 3, expected: 0b1111111111111000 },
        TestCase { lhs: 0b1111111111111111, rhs: 4, expected: 0b1111111111110000 },
        TestCase { lhs: 0b1111111111111111, rhs: 5, expected: 0b1111111111100000 },
        TestCase { lhs: 0b1111111111111111, rhs: 6, expected: 0b1111111111000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 7, expected: 0b1111111110000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 8, expected: 0b1111111100000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 9, expected: 0b1111111000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 10, expected: 0b1111110000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 11, expected: 0b1111100000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 12, expected: 0b1111000000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 13, expected: 0b1110000000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 14, expected: 0b1100000000000000 },
        TestCase { lhs: 0b1111111111111111, rhs: 15, expected: 0b1000000000000000 },
        ...
        TestCase { lhs: 0b1010101010101010, rhs: 8, expected: 0b1010101000000000 },
    ];
