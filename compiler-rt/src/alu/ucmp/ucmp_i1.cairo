...
pub fn __llvm_ucmp_c_c_b(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
...
mod tests {
    ...
    fn test_i1() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_ucmp_c_c_b(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
