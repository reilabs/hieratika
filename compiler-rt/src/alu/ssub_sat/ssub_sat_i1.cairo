...
pub fn __llvm_ssub_sat_c_c_c(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    ...
    ssub_sat::<u8>(lhs, rhs) & 0b1
}

#[cfg(test)]
mod tests {
    use crate::rtstate::RTStateOps;
    use super::__llvm_ssub_sat_c_c_c;
    ...
    fn test_i1() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_ssub_sat_c_c_c(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
