...
pub fn __llvm_fshr_i8_i8_i8(a: u128, b: u128, shift: u128) -> u128 {
    fshr::<u8>(a, b, shift)
}

#[cfg(test)]
mod tests {
    use super::__llvm_fshr_i8_i8_i8;
    ...
    fn test_i8() {
        for case in test_cases
            .span() {
                assert_eq!(__llvm_fshr_i8_i8_i8(*case.a, *case.b, *case.c), *case.expected);
            }
    }
}
