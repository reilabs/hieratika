...
pub fn __llvm_fshr_z_z_z_z(ref state: RTState, a: u128, b: u128, shift: u128) -> u128 {
    fshr::<u16>(a, b, shift)
}
...
mod tests {
    ...
    fn test_i16() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_fshr_z_z_z_z(ref state, *case.a, *case.b, *case.c), *case.expected);
        }
    }
}
