...
mod tests {
    ...
    pub const test_cases: [TestCase; 25] = [
        ...
        TestCase { lhs: 0b11111111, rhs: 1, expected: 0b01111111 },
        TestCase { lhs: 0b11111111, rhs: 2, expected: 0b00111111 },
        TestCase { lhs: 0b11111111, rhs: 3, expected: 0b00011111 },
        TestCase { lhs: 0b11111111, rhs: 4, expected: 0b00001111 },
        TestCase { lhs: 0b11111111, rhs: 5, expected: 0b00000111 },
        TestCase { lhs: 0b11111111, rhs: 6, expected: 0b00000011 },
        TestCase { lhs: 0b11111111, rhs: 7, expected: 0b00000001 },
        ...
        TestCase { lhs: 0b10101010, rhs: 4, expected: 0b1010 },
    ];
