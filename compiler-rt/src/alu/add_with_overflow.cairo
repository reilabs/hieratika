...
>(
    ...
    // It is possible overflow would happen if the addition was done in T. Since it was done in
    // u128, the flag may not be set if T is short. We need to do an extra check if the actual
    // bit width of result is more than the bit width of T.
