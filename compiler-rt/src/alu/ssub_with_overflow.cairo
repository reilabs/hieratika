...
>(
    ...
    // It is possible that overflow would happen if the subtraction was done in T. Since it was done
    // in u128, the flag may not be set if the result of the operation would overflow T but did not
    // overflow u128.
    ...
    let overflow_flag: bool = if !overflow_flag {
        ...
        // (assuming both operands had different signs)
