...
pub fn __llvm_uadd_with_overflow_c_c_Sccs(lhs: u128, rhs: u128) -> (u128, bool) {
    ...
    let (res, o) = uadd_with_overflow::<u8>(lhs, rhs);
    (res & 0b1, o)
}

#[cfg(test)]
mod tests {
    use super::__llvm_uadd_with_overflow_c_c_Sccs;
    ...
    fn test_i1() {
        for case in test_cases.span() {
            assert_eq!(__llvm_uadd_with_overflow_c_c_Sccs(*case.lhs, *case.rhs), *case.expected);
        }
    }
}
