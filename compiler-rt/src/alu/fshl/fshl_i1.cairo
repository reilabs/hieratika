...
pub fn __llvm_fshl_c_c_c_c(ref state: RTState, a: u128, b: u128, shift: u128) -> u128 {
    if a > 1 {
    ...
    // That means we never shift and the answer is always a.
    a
}
...
mod tests {
    ...
    pub const test_cases: [TestCaseThreeArgs; 12] = [
        ...
        TestCaseThreeArgs { a: 0b0, b: 0b1, c: 0, expected: 0b0 },
        TestCaseThreeArgs { a: 0b0, b: 0b1, c: 1, expected: 0b0 },
        TestCaseThreeArgs { a: 0b0, b: 0b1, c: 2, expected: 0b0 },
        TestCaseThreeArgs { a: 0b1, b: 0b0, c: 0, expected: 0b1 },
        TestCaseThreeArgs { a: 0b1, b: 0b0, c: 1, expected: 0b1 },
        TestCaseThreeArgs { a: 0b1, b: 0b0, c: 2, expected: 0b1 },
    ...
    fn test_i1() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_fshl_c_c_c_c(ref state, *case.a, *case.b, *case.c), *case.expected);
        }
    }
}
