...
use crate::alu::add_with_overflow::{uadd_with_overflow, sadd_with_overflow};
...
// are defined and tested in uadd_sat/uadd_sat_<type>.cairo files.
fn uadd_sat<
    T,
...
//
// This is a generic implementation for every data type. Its specialized versions
// are defined and tested in sadd_sat/sadd_sat_<type>.cairo files.
fn sadd_sat<
    T,
    // The trait bounds are chosen so that:
    //
