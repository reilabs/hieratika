...
pub fn __llvm_icmp_sgt_c_c_c(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
...
mod tests {
    ...
    use super::__llvm_icmp_sgt_c_c_c;
    ...
    fn test_i1() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_icmp_sgt_c_c_c(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
