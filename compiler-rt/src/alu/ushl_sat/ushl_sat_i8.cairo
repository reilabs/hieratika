...
pub fn __llvm_ushl_sat_b_b_b(ref state: RTState, n: u128, shift: u128) -> u128 {
    ushl_sat::<u8>(n, shift)
}
...
mod tests {
    ...
    use super::__llvm_ushl_sat_b_b_b;
    ...
    fn test_i8() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_ushl_sat_b_b_b(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
