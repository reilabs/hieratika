...
pub fn __llvm_udiv_x_x_x(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    udiv::<u24>(lhs, rhs)
}
...
mod tests {
    ...
    fn test_i24() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_udiv_x_x_x(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
    ...
    fn test_div_by_zero() {
        let mut state = RTStateOps::new();
        __llvm_udiv_x_x_x(ref state, 1, 0);
    }
}
