...
pub fn __llvm_icmp_slt_b_b_c(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    icmp_slt::<u8>(lhs, rhs)
}
...
mod tests {
    ...
    use super::__llvm_icmp_slt_b_b_c;
    ...
    fn test_i8() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_icmp_slt_b_b_c(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
