...
pub fn __llvm_smax_b_b_b(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    smax::<u8>(lhs, rhs)
}
...
mod tests {
    ...
    fn test_i8() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_smax_b_b_b(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
}
