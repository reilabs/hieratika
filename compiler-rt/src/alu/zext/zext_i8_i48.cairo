...
pub fn __llvm_zext_b_to_k(ref state: RTState, value: u128) -> u128 {
    zext::<u48>(value)
}
...
mod tests {
    ...
    pub const test_cases: [TestCaseOneArg; 2] = [
        ...
        TestCaseOneArg { arg: 0b11111111, expected: 0b000000000000000000000000000000000000000011111111 },
    ];
    ...
    fn test_i8_i48() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_zext_b_to_k(ref state, *case.arg), *case.expected);
        }
    }
}
