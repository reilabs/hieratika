...
pub fn __llvm_zext_i_to_n(ref state: RTState, value: u128) -> u128 {
    zext::<u40>(value)
}
...
mod tests {
    ...
    pub const test_cases: [TestCaseOneArg; 2] = [
        ...
        TestCaseOneArg { arg: 0b11111111111111111111111111111111, expected: 0b0000000011111111111111111111111111111111 },
    ];
    #[test]
    fn test_i32_i40() {
        for case in test_cases.span() {
            let mut state = RTStateOps::new();
            assert_eq!(__llvm_zext_i_to_n(ref state, *case.arg), *case.expected);
        }
    }
}
