...
pub fn __llvm_zext_i_to_l(ref state: RTState, value: u128) -> u128 {
    zext::<u64>(value)
}
...
mod tests {
    ...
    pub const test_cases: [TestCaseOneArg; 2] = [
        ...
        TestCaseOneArg { arg: 0b11111111111111111111111111111111, expected: 0b0000000000000000000000000000000011111111111111111111111111111111 },
    ];
    #[test]
    fn test_i32_i64() {
        for case in test_cases.span() {
            let mut state = RTStateOps::new();
            assert_eq!(__llvm_zext_i_to_l(ref state, *case.arg), *case.expected);
        }
    }
}
