...
pub fn __llvm_abs_i_c_i(ref state: RTState, arg: u128, _is_int_min_poison: u128) -> u128 {
    abs::<u32>(arg)
}
...
mod tests {
    ...
    fn test_i32() {
        ...
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_abs_i_c_i(ref state, *case.arg, unused), *case.expected);
        }
    }
}
