...
pub fn __llvm_sdiv_b_b_b(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    sdiv::<u8>(lhs, rhs)
}
...
mod tests {
    ...
    fn test_i8() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_sdiv_b_b_b(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
    ...
    fn test_div_by_zero() {
        let mut state = RTStateOps::new();
        __llvm_sdiv_b_b_b(ref state, 1, 0);
    }
}
