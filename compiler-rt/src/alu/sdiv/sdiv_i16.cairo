...
pub fn __llvm_sdiv_z_z_z(ref state: RTState, lhs: u128, rhs: u128) -> u128 {
    sdiv::<u16>(lhs, rhs)
}
...
mod tests {
    ...
    fn test_i16() {
        for case in test_cases.span() {
            ...
            assert_eq!(__llvm_sdiv_z_z_z(ref state, *case.lhs, *case.rhs), *case.expected);
        }
    }
    ...
    fn test_div_by_zero() {
        let mut state = RTStateOps::new();
        __llvm_sdiv_z_z_z(ref state, 1, 0);
    }
}
