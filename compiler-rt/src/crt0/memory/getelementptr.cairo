...
///
/// The function returns the computed address,
pub fn getelementptr(base: Address, offset: i64) -> Address {
...
mod test {
    ...
    #[test]
    fn test_getelementptr_positive_offset() {
        let base: Address = 1000;
        let offset: i64 = 50;
        let result = getelementptr(base, offset);
        assert_eq!(result, 1050);
    }

    #[test]
    fn test_getelementptr_negative_offset() {
        let base: Address = 1000;
        let offset: i64 = -50;
        let result = getelementptr(base, offset);
    ...
    #[test]
    fn test_getelementptr_zero_offset() {
        let base: Address = 1000;
        let offset: i64 = 0;
        let result = getelementptr(base, offset);
    ...
    #[test]
    fn test_getelementptr_large_positive_offset() {
        let base: Address = 1000;
    ...
    #[test]
    fn test_getelementptr_large_negative_offset() {
