...
///
/// This is the implementation of the `__llvm_atomicrmw_and_*` polyfills logic. It exists so that
...
mod test {
    ...
    #[test]
    /// Test the `atomicrmw and` operation with u8 values.
    fn atomicrmw_and_u8() {
        test_atomicrmw_and::<u8>(0x12);
    }

    #[test]
    /// Test the `atomicrmw and` operation with u16 values.
    fn atomicrmw_and_u16() {
        test_atomicrmw_and::<u16>(0x1234);
    }
    ...
    #[test]
    /// Test the `atomicrmw and` operation with u32 values.
    fn atomicrmw_and_u32() {
        test_atomicrmw_and::<u32>(0x12345678);
    }
    ...
    #[test]
    /// Test the `atomicrmw and` operation with u64 values.
    fn atomicrmw_and_u64() {
        test_atomicrmw_and::<u64>(0x123456789abcdef0);
    }

    #[test]
    /// Test the `atomicrmw and` operation with u128 values.
    fn atomicrmw_and_u128() {
        test_atomicrmw_and::<u128>(0x123456789abcdef0123456789abcdef0);
    }
}
