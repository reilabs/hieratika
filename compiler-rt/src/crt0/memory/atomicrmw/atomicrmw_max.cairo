...
/// store the greater value into the memory. Signed comparison is performed.
...
pub fn __llvm_atomicrmw_max_p_b_b(address: Address, value: u8) -> u8 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_z_z(address: Address, value: u16) -> u16 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_x_x(address: Address, value: u24) -> u24 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_i_i(address: Address, value: u32) -> u32 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_n_n(address: Address, value: u40) -> u40 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_k_k(address: Address, value: u48) -> u48 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_l_l(address: Address, value: u64) -> u64 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_o_o(address: Address, value: u128) -> u128 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_max(ref allocator, address, value)
}
