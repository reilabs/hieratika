...
>(
    ...
    let greater_value = smax::<T>(old_value, value);
...
mod test {
    ...
    fn atomicrmw_max_u24() {
        test_atomicrmw_max::<u24>(0x7fffff);
    }
    ...
    fn atomicrmw_max_u40() {
        test_atomicrmw_max::<u40>(0x7fffffffff);
    }

    #[test]
    /// Test the `atomicrmw max` operation with u48 values.
    fn atomicrmw_max_u48() {
        test_atomicrmw_max::<u48>(0x7fffffffffff);
    }
...
pub fn __llvm_atomicrmw_max_p_b_b(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u8>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_z_z(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u16>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_x_x(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u24>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_i_i(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u32>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_n_n(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u40>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_k_k(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u48>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_l_l(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u64>(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_max_p_o_o(ref state: RTState, address: Address, value: u128) -> u128 {
    atomicrmw_max::<u128>(ref state.allocator, address, value)
}
