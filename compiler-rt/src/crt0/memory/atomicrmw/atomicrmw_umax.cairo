...
/// store the greater value into the memory. Unsigned comparison is performed. The value loaded from
...
///
/// This is the implementation of the `__llvm_atomicrmw_umax_*` polyfills logic. It exists so that
...
mod test {
    ...
    #[test]
    /// Test the `atomicrmw umax` operation with u8 values.
    fn atomicrmw_umax_u8() {
        test_atomicrmw_umax::<u8>(0xff);
    }

    #[test]
    /// Test the `atomicrmw umax` operation with u16 values.
    fn atomicrmw_umax_u16() {
        test_atomicrmw_umax::<u16>(0xffff);
    }
    ...
    #[test]
    /// Test the `atomicrmw umax` operation with u32 values.
    fn atomicrmw_umax_u32() {
        test_atomicrmw_umax::<u32>(0xffffffff);
    }
    ...
    #[test]
    /// Test the `atomicrmw umax` operation with u64 values.
    fn atomicrmw_umax_u64() {
        test_atomicrmw_umax::<u64>(0xffffffffffffffff);
    }

    #[test]
    /// Test the `atomicrmw umax` operation with u128 values.
    fn atomicrmw_umax_u128() {
        test_atomicrmw_umax::<u128>(0xffffffffffffffffffffffffffffffff);
    }
}

pub fn __llvm_atomicrmw_umax_p_b_b(address: Address, value: u8) -> u8 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_z_z(address: Address, value: u16) -> u16 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_x_x(address: Address, value: u24) -> u24 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_i_i(address: Address, value: u32) -> u32 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_n_n(address: Address, value: u40) -> u40 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_k_k(address: Address, value: u48) -> u48 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_l_l(address: Address, value: u64) -> u64 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}

pub fn __llvm_atomicrmw_umax_p_o_o(address: Address, value: u128) -> u128 {
    let mut allocator = get_allocator().unbox();
    atomicrmw_umax(ref allocator, address, value)
}
