...
mod test {
    ...
    fn atomicrmw_or_u24() {
        test_atomicrmw_or::<u24>(IntegerOps::new(0x123456));
    }
    ...
    fn atomicrmw_or_u40() {
        test_atomicrmw_or::<u40>(IntegerOps::new(0x123456789a));
    }

    #[test]
    /// Test the `atomicrmw or` operation with u48 values.
    fn atomicrmw_or_u48() {
        test_atomicrmw_or::<u48>(IntegerOps::new(0x123456789abc));
    }
...
pub fn __llvm_atomicrmw_or_p_b_b(ref state: RTState, address: Address, value: u8) -> u8 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_z_z(ref state: RTState, address: Address, value: u16) -> u16 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_x_x(ref state: RTState, address: Address, value: u24) -> u24 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_i_i(ref state: RTState, address: Address, value: u32) -> u32 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_n_n(ref state: RTState, address: Address, value: u40) -> u40 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_k_k(ref state: RTState, address: Address, value: u48) -> u48 {
    atomicrmw_or(ref state.allocator, address, value)
}

pub fn __llvm_atomicrmw_or_p_l_l(ref state: RTState, address: Address, value: u64) -> u64 {
    atomicrmw_or(ref state.allocator, address, value)
}
