...
pub enum Command {
    ...
    /// Build and execute the provided LLVM IR file using Hieratika.
    ///
    /// This command prints the program's result upon a successful execution,
    /// and prints the panic data if the execution panics.
    Run(RunArgs),
}
...
pub struct RunArgs {
    ...
    /// The output path for compilation. If it is not provided a temporary
    /// directory is used.
